...
public class ProductDaoImpl implements ProductDao{
	...
	@Override
	public ProductVo selectById(final String id) { 
		String sql = "select * from product where id=?";
		List<ProductVo> products = jdbcTemplate.query(sql, 
	...
	public void insert(ProductVo product) {
		String sql = "insert into product (id, name, price, registerDate) "+"values(?, ?, ?, ?)";
	...
	public void update(ProductVo product) {
		String sql = "update product set name=?, price=?, registerDate=? "
				+"where id=?";
